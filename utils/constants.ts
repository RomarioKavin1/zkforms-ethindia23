export const ZK_FORM_FACTORY_ABI = [
  {
    inputs: [
      { internalType: "address", name: "_formImplementaion", type: "address" },
      { internalType: "address", name: "zetaToken", type: "address" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string", name: "encryptedFormData", type: "string" },
      { internalType: "bytes16[]", name: "proofRequests", type: "bytes16[]" },
      { internalType: "uint256", name: "amount", type: "uint256" },
      { internalType: "uint256", name: "numberOfPeople", type: "uint256" },
    ],
    name: "createForm",
    outputs: [{ internalType: "address", name: "form", type: "address" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    inputs: [{ internalType: "address", name: "form", type: "address" }],
    name: "formExists",

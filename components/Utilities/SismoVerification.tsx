  ...
  return (
    <div className="min-h-screen w-full overflow-auto bg-gradient-to-tr from-indigo-100 via-purple-50 to-teal-100 px-4">
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          >
            <div className="mt-4 justify-start">
              ...
              <h1 className="bg-gradient-to-r from-purple-800 to-green-500 bg-clip-text pt-5 text-sm font-bold text-transparent opacity-75 sm:text-2xl md:text-left md:text-5xl">
                Sismo - Verification
              </h1>
            </div>
          </div>
      ...
      <div className="flex justify-center">
        <div className="mt-4 w-full rounded-[20px] border-2 border-black bg-[#FFCF5340]/25 p-4 px-8 lg:w-8/12">
          <div>
